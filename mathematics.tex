...
(\alpha \rho_v)^{n+1} + \frac{\Delta t}{V_m}\left[\sum_{axial} \frac{(\alpha \rho_{v})_{don}^{n}A_{m}}{A_{c}<\alpha \rho_v>^{n}} \dot{\vec{M}}^{n+1}_{v}\cdot \vec{\hat{n}} + \sum_{gaps} \frac{(\alpha \rho_{v})_{don}^{n} \Delta w_{g} \Delta x_{m}}{A_{c}<\alpha \rho_v>^{n}} \dot{\vec{W}}^{n+1}_{v}\cdot \vec{\hat{n}}\right] & & \nonumber \\
= \Delta t \left((\alpha \rho_v)^{n} + \Gamma^{\,n} + \nabla\cdot \Vec{G}_{v}^{n}\right) & & \\
(\alpha \rho_g)^{n+1} + \frac{\Delta t}{V_m}\left[\sum_{axial} \frac{(\alpha \rho_{g})_{don}^{n}A_{m}}{A_{c}<\alpha \rho_g>^{n}} \dot{\vec{M}}^{n+1}_{v}\cdot \vec{\hat{n}} + \sum_{gaps} \frac{(\alpha \rho_{g})_{don}^{n} \Delta w_{g} \Delta x_{m}}{A_{c}<\alpha \rho_g>^{n}} \dot{\vec{W}}^{n+1}_{v}\cdot \vec{\hat{n}}\right] & & \nonumber \\
= \Delta t \left((\alpha \rho_g)^{n} + \Gamma^{\,n} + \nabla\cdot \Vec{G}_{g}^{n}\right) & &  \\
(\alpha_l \rho_l)^{n+1} + \frac{\Delta t}{V_m}\left[\sum_{axial} \frac{(\alpha_l \rho_{l})_{don}^{n}A_{m}}{A_{c}<\alpha_l \rho_l>^{n}} \dot{\vec{M}}^{n+1}_{l}\cdot \vec{\hat{n}} + \sum_{gaps} \frac{(\alpha_l \rho_{l})_{don}^{n} \Delta w_{g} \Delta x_{m}}{A_{c}<\alpha_l \rho_l>^{n}} \dot{\vec{W}}^{n+1}_{l}\cdot \vec{\hat{n}}\right] & & \nonumber \\
= \Delta t \left((\alpha_l \rho_l)^{n} -\Gamma^{\,n}_{l} + \nabla\cdot \Vec{G}_{l}^{n} - S'''\right) & & \\
(\alpha_e \rho_l)^{n+1} + \frac{\Delta t}{V_m}\left[\sum_{axial} \frac{(\alpha_e \rho_{l})_{don}^{n}A_{m}}{A_{c}<\alpha_e \rho_l>^{n}} \dot{\vec{M}}^{n+1}_{e}\cdot \vec{\hat{n}} + \sum_{gaps} \frac{(\alpha_e \rho_{l})_{don}^{n} \Delta w_{g} \Delta x_{m}}{A_{c}<\alpha_e \rho_l>^{n}} \dot{\vec{W}}^{n+1}_{e}\cdot \vec{\hat{n}}\right] & & \nonumber \\
= \Delta t \left((\alpha_e \rho_l)^{n} - \Gamma^{\,n}_{e} - S'''\right)& & 
\end{IEEEeqnarray}

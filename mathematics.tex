...
\frac{\partial\; \vec{N}(\vec{x}_{k})}{\partial \vec{x}_{k}} & = & \mat{N}(\dot{\vec{M}}_{k})\dot{\vec{M}}_{k} \nonumber \\
\frac{\partial\; \vec{F}(\vec{x}_{k})}{\partial \dot{\vec{M}_{k}}} & = & \frac{\partial}{\partial \vec{\dot{M}}_{k}}\left[ \vec{E} + \vec{L}(\vec{x}_{k}) + \vec{N}(\vec{x}_{k})\right] = \left[\mat{L}+\mat{N}(\dot{\vec{M}}_{k})\right]  \nonumber \\
\mat{J}_{k} & = & \left[\mat{L}+\mat{N}(\dot{\vec{M}}_{k})\right] \nonumber
\end{IEEEeqnarray}

\begin{IEEEeqnarray}{rCl}
\vec{F}(\vec{x}_{k+1}) & = & 0 \nonumber \\
\vec{F}(\vec{x}_{k+1}) & = & \vec{E} + \vec{L}(\vec{x}_{k+1}) + \vec{N}(\vec{x}_{k+1}) \nonumber \\
...
\begin{IEEEeqnarray}{rCl}
 \mat{L}\;\dot{\vec{M}}_{k+1} + \mat{N}(\dot{\vec{M}}_{k})\;\dot{\vec{M}}_{k+1} & = & -\vec{E} - \vec{b}\Delta \text{P}_{k} - \vec{N}(\vec{x}_{k}) - \vec{b}\delta(\Delta \text{P}) + \mat{N}(\dot{\vec{M}}_{k}) \nonumber \\
 ...
 \mat{J}_{\,k}\; \dot{\vec{M}}_{k+1} & = &  -\vec{a} - \vec{b}\delta(\Delta \text{P}) \nonumber \\
\dot{\vec{M}}_{k+1} & = &  -\mat{J}_{\,k}^{-1}\;\vec{a} - \mat{J}^{-1}_{\,k}\;\vec{b}\delta(\Delta \text{P}) \nonumber
\end{IEEEeqnarray}

\begin{IEEEeqnarray}{rCl}
\left[\mat{L} + \mat{N}(\dot{\vec{M}}_{k})\right]\dot{\vec{M}}_{k+1} & = & - \left[\vec{E} + \mat{L}\;\dot{\vec{M}}_{k} + \vec{b}\text{P}_{k} + \vec{N}(\vec{x}_{k}) \right] - \vec{b}\delta\text{P} + \mat{L}\;\dot{\vec{M}}_{k} + \mat{N}(\dot{\vec{M}}_{k})\;\dot{\vec{M}}_{k} \nonumber \\
\left[\mat{L} + \mat{N}(\dot{\vec{M}}_{k})\right]\dot{\vec{M}}_{k+1} & = & - \vec{F}(\vec{x}_{k}) - \vec{b}\delta\text{P} + \left[\mat{L} + \mat{N}(\dot{\vec{M}}_{k})\right]\;\dot{\vec{M}}_{k} \nonumber \\
\mat{J}_{\,k}\,\dot{\vec{M}}_{k+1} & = & - \vec{F}(\vec{x}_{k}) - \vec{b}\delta\text{P} + \mat{J}_{\,k}\;\dot{\vec{M}}_{k} \nonumber \\
\dot{\vec{M}}_{k+1} & = & \dot{\vec{M}}_{k} - \mat{J}_{\,k}^{-1} \vec{F}(\vec{x}_{k}) - \mat{J}_{\,k}^{-1}\vec{b}\delta\text{P} \nonumber \\
\mat{J}_{\,k}\,\delta\dot{\vec{M}} & = & - \vec{F}(\vec{x}_{k}) - \vec{b}\delta\text{P} \nonumber \\
\mat{J}_{\,k}\,\delta\dot{\vec{x}} & = & - \vec{F}(\vec{x}_{k}) \nonumber
\end{IEEEeqnarray}

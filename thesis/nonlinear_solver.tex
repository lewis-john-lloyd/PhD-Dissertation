...
In order to determine the degree to which a state vector, $\vec{x}$, satisfies the governing PDEs, \eqref{eqn:conservation_equations}, the use of the nonlinear residual is required.

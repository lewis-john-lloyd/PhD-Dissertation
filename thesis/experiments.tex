...
The nonlinear convergence criteria used in the nonlinear solver are described in \sect{sect:nln_cobra_alg}.
...
The result of each decomposed problem was compared to both experimental results and the compational results from having the entire domain in the linear domain and the entire domain in the nonlinear domain.
Appendix \ref{} contains the files used to run the tests.

...
At that time the hybrid method will be tested, with regions of high-nonlinearities targeted as predetermined subdomain.
...
Another issue that needs to be addressed is the proper scaling for the Newton update.
...
Run time for various problems should be evaluated.
Convergence criteria, maximum iteration count, and globalization parameters should be varied for a set number of problems to determine performance.

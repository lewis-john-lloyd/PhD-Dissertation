...
Given the results from \chap{chap:numerical_experiments}, the next step will be to implement the aforementioned internal coupling to COBRA-IE.
...
At that point, the experiments defined in \chap{chap:numerical_experiments} will be run again with the domain decomposition selectively hard coded to the region of the problems identified as having a large nonlinear residual.

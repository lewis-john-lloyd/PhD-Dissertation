...
Conservation of the Continuous Liquid Field Momentum   &  $ u_l \frac{\alpha_{l, \text{min}} \ave{\rho_l}_{\text{a}} }{\ave{\alpha_l \rho_l}_{\text{a}}} A_{mom}$  \\
Conservation of the Entrained Liquid Field Momentum    &  $ u_e \frac{\alpha_{e, \text{min}} \ave{\rho_l}_{\text{a}} }{\ave{\alpha_e \rho_l}_{\text{a}}} A_{mom}$  \\
Conservation of the Gaseous Phase Momentum             &  $ u_g \frac{\alpha_{g, \text{min}} \ave{\rho_g}_{\text{a}} }{\ave{\alpha_g \rho_g}_{\text{a}}} A_{mom}$ \\
}

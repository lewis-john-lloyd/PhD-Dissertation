...
The question of temporal convergence, as outlined in \sect{sect:temporal_convergence}, is linked not only to the particular method used for approximating the temporal derivatives in , but also to the degree to which the nonlinearities are resolved over that time-step. 

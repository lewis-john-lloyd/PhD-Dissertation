...
The single-phase case was designed to test the hypothesis that the the linearized solver produced a simulation result that was equivalent to that produced by the nonlinearly convergent case.

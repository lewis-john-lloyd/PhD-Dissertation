...
Unfortunately, the subjective meaning of temporal convergence will always be subject to some form of engineering judgment.
...
As the time-step size is reduced, this discrepancy does does disappear, \fig{fig:flashing_1em5}.
...
Notice however, that the solution to the flashing problem produced by the nonlinear mode of \cobra{} varies less as the time-step size is reduced that that produced by the legacy mode, \fig{fig:nl_mode_flashing} and \fig{fig:cobra_mode_flashing}.
\fig{fig:cobra_mode_flashing} shows that as the time-step size is reduced the nonlinear solution approaches a solution that is time-step size insensitive.
...
The nonlinear residual for the legacy Flashing problem indicates that even for small time-step sizes, the solution obtained still does not satisfy the discrete nonlinear equations, \fig{fig:legacy_flashing_residual}.

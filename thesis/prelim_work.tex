...
Since both objectives depend upon the scaling of the nonlinear residuals, a novel operator-based scaling has been developed to obtain meaningful convergence thresholds.
...
This scaling produces a non-dimensionalized residual that is relative to the physical sources and sinks on a per equation basis. 

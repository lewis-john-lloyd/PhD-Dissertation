...
The primary objective of these tests is to determine the impact of resolving the nonlinearities at each time step for a given maximum time-step size on the number of time-step size refinements necessary to reach a temporally converged solution.
...
\comment{Yes, a bunch of work required.}

...
For the work performed here, that value was dropped down to $\alpha_{k,\text{MIN}}$ = 1.0E-9.
...
\subfloat[Legacy mode solution.]{\includegraphics[width=0.49\textwidth]{images/cobra_flashing_1em3_1em4.eps}
...
The residual of the legacy mode solution for the single-phase problem, \fig{fig:leg_single_res}, shows that the nonlinear residuals is almost zero except in to regions.
...
This difference manifests itself in the nonlinear residuals of the nonlinear mode solution around 1 [s], \fig{fig:nl_res_single_zoom}.
At \dtmax{} = 1.0E-3, the nonlinear residual increases from effectively zero at \dtmax{} = 1.0E-2.
This behavior of the solution at those 	

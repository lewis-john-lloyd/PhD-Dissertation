...
ylabel('$\alpha_g$ [-] @ 2 [in] from Inlet','Interpreter','latex','FontSize',16)
xlabel('Time [s]','Interpreter','latex','FontSize',16)
fleg3 = legend( char(f(1).grandkids(2).data(6).legend_entry),...
                ...
                0);
set(fleg3,'Interpreter','latex','FontSize',16)
...
ylabel('$\alpha_g$ [-] @ 2 [in] from Inlet','Interpreter','latex','FontSize',16)
xlabel('Time [s]','Interpreter','latex','FontSize',16)
fleg4 = legend( char(f(3).grandkids(2).data(6).legend_entry),...
...
set(fleg4,'Interpreter','latex','FontSize',16)
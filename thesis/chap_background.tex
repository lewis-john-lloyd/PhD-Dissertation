...
The following chapter provides a review of the pertinent mathematical and theoretical material for this research.
First, the geometric discretization used in this work is discussed.
Second, the governing conservation equations for mass, momentum, and energy are detailed.
The numerical approximations with respect to space, time, and nonlinearities are then covered.
Next, the various methods used to solve the system of discrete governing equations are presented.
And last, the various means by which thermal-hydraulic safety analysis software has traditionally been coupled are presented.
...
There is one mesh comprised of continuity volumes and another comprised of momentum flow paths, \fig{fig:staggered_mesh}.

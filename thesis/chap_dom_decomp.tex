...
From \sect{sec:domDecompMath} and \eqref{eqn:linearDomainPressureUpdates}, each NBC volume has an associated pressure equation.
...
For each connecting flow path, the contribution is calculated and stored in the row of \vec{A} associated with the outer NBC volume. 

...
\comment{
I am contemplating a reorganization of this chapter.
The mathematical formulation is effectively the implementation without specifics.
I feel that there is a large amount of redundancy between \sect{sec:domDecompMath} and \sect{sec:dd_algo}.
I think that I may consolidate the two sections into one and not have any subsections in this chapter.
Also, I know that the nomenclature may be inconsistent in places, but that is being ironed out at the moment.
}
...
\comment{
I am going to be adjusting this section.
I think that expressing this operations as a collections of columns as opposed to matrices will make this easier to explain.
Also, I am going to work the fact that for the nonlinear boundary volume, the residual does not contain the flux at first.
I can show that more easily than with the matrices below.
Also, I need to be careful because the coupling is done not through fluxes, but through flowrates.
I need to ensure that the flowrates is used.
}
...
Once the pressure equations for the nonlinear boundary volumes have been inset in the nonlinear pressure matrix, the pressure matrix for the nonlinear domain is solved.

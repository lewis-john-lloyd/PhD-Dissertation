...
The computational grid used in \cobra{} is a staggered mesh.
...
\fig{fig:venn_diagram} shows a Venn diagram of the current methods for reactor safety.
...
\fig{fig:my_venn_diagram} shows where the current work will fit into this paradigm.

\begin{figure}[h!t]
\centering
\subfloat[Traditional methods.]{
%\includegraphics[width=0.49\textwidth]{images/venn_diagram.eps}
Blarp!
\label{fig:venn_diagram}}
\subfloat[Proposed method.]{
%\includegraphics[width=0.49\textwidth]{images/my_venn_diagram.eps}
Blarper!
\label{fig:my_venn_diagram}}
\caption{Thermal-hydraulic safety software.}

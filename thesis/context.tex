...
It is also possible to model multi-dimensional flow through the definition of transverse flow paths that connect two channels within a given section to each other.
...
The benefits of modeling the dispersed liquid field allow to capture these complex hydrodynamic phenomena have inspired the French CATHARE software developers to migrate to a similar three-field formulation in the next version of their software \cite{Emonot2011}.

...
The velocity and cross-sectional area utilized in the continuity flux terms, $u_{j \pm \onehalf}$ and $A_{m,j \pm \onehalf}$, have the values defined in the momentum volume that aligns with the boundary of continuity volumes.
...
Second, the phasic velocity that is used to determine the donored quantities is the arithmetic mean of the velocities from the two adjacent momentum volumes, \eqref{eqn:average_advecting_vel}.
...
The use of the momenta and phasic enthalpies, such as $\alpha_g h_v$, as independent parameters represents.

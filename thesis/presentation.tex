...
\begin{itemize}
\item{Smallest per timestep computational cost.}
...
I need to test convergence tolerances of the newton-loop.
I need to test metric values to determine when a solution is "good enough."
...
It can provide a speed-up.
It can provide an answer about nonlinear convergence affecting solutions.

\begin{itemize}
\item{I am a good outcome.}
\item{I am a not-so-good outcome.}
\item{I am the end.}
\end{itemize}

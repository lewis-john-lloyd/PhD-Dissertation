...
% Chapters 1 and 2
%\includeonly{chap_introduction,chap_nonlinear_solver}
% Chapter 2
%\includeonly{chap_nonlinear_solver}
% Chapter 3
%\includeonly{chap_dom_decomp}
% Chapters 2 and 3
%\includeonly{chap_nonlinear_solver,chap_dom_decomp}
% Chapters 1 through 3
\includeonly{chap_introduction,chap_nonlinear_solver,chap_dom_decomp}
% Chapters 1 through 3 and 5

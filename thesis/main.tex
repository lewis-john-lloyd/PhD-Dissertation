...
\include{literature}    % Chapter: Pertinent research.
\include{justification} % Chapter: Proof of worthiness. 
...
\include{semi_implicit}		 % Appendix: Verification Work
\include{nonlinear_solver}   %      

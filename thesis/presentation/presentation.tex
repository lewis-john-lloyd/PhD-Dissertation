...
%---------
\begin{frame}
\frametitle{Timestep Sensitivity and Convergence Parameters}
...
Nonlinear convergence parameters, unless otherwise stated, are \kmax{} = 35, $F_{\text{tol}}$ = \expneg{1.0}{6}, $\delta_{\text{tol}}$ = \expneg{1.0}{8}.

...
\frac{\partial \vec{F}^{k}_{c}}{\partial \alpha_{e}} \delta \alpha_{e}^{k} + \left( \frac{\partial \vec{F}^{k}_{c}}{\partial P } + \alert<1>{\sum_{i\,\in \, N_{f} } \vec{\Xi}^{k}_{i}\frac{\partial \momVec{}^{k}_{i}}{\partial P_{s(i)}}}\right) \delta P^{k} + \alert<1>{\sum_{i \, \in \, N_{f} } \vec{\Xi}^{k}_{i} \frac{\partial \momVec{}_{i}^{k}}{\partial P_{o(i)}} \delta P_{o(i)}^{k}} & = & \nonumber \\
- \vec{F}^{k}_{c} \alert<1>{- \sum_{i \, \in \, N_{f} } \vec{\Xi}^{k}_{i} \delta \momVec{}_{i}^{*}} \nonumber & &
\end{IEEEeqnarray}
...
%---------
\begin{frame}
\frametitle{Linear Solver's Timestep Size Sensitive Solution}
...
\begin{IEEEeqnarray}{rcl}
\frac{\partial \vec{F}^{k}_{c}}{\partial (\alpha_{g} P_{n} )} \delta (\alpha_{g} P_{n})^{k} + \frac{\partial \vec{F}^{k}_{c}}{\partial \alpha_{g}} \delta \alpha^{k}_{g} + \frac{\partial \vec{F}^{k}_{c}}{\partial (\alpha_{g} h_{v} )} \delta (\alpha_{g} h_{v})^{k} + \frac{\partial \vec{F}^{k}_{c}}{\partial ((1 - \alpha_{g}) h_{l} )} \delta ((1 - \alpha_{g}) h_{l})^{k} & + &  \nonumber \\
\frac{\partial \vec{F}^{k}_{c}}{\partial \alpha_{e}} \delta \alpha_{e}^{k} + \frac{\partial \vec{F}^{k}_{c}}{\partial P } \delta P^{k} + \sum_{i \, \in \, N_{f} } \frac{\partial \vec{F}^{k}_{c}}{\partial \momVec{}_{i} } \delta \momVec{}_{i}^{k} \alert<1>{+ \sum_{i\,\in \, N_{\text{NBC}}} \frac{\partial \vec{F}^{k}_{c}}{\partial \vec{\Psi}_{i} } \delta \vec{\Psi}_{i}^{k}}  = - \vec{F}^{k}_{c} & &\nonumber 
\end{IEEEeqnarray}

\begin{IEEEeqnarray}{rcl}
\frac{\partial \vec{F}^{k}_{c}}{\partial (\alpha_{g} P_{n} )} \delta (\alpha_{g} P_{n})^{k} + \frac{\partial \vec{F}^{k}_{c}}{\partial \alpha_{g}} \delta \alpha^{k}_{g} + \frac{\partial \vec{F}^{k}_{c}}{\partial (\alpha_{g} h_{v} )} \delta (\alpha_{g} h_{v})^{k} + \frac{\partial \vec{F}^{k}_{c}}{\partial ((1 - \alpha_{g}) h_{l} )} \delta ((1 - \alpha_{g}) h_{l})^{k} & + & \nonumber \\
\frac{\partial \vec{F}^{k}_{c}}{\partial \alpha_{e}} \delta \alpha_{e}^{k} + \left( \frac{\partial \vec{F}^{k}_{c}}{\partial P } + \sum_{i \, \in \, N_{f} } \vec{\Xi}^{k}_{i}\frac{\partial \momVec{}^{k}_{i}}{\partial P}\right) \delta P^{k} + \sum_{i \, \in \, N_{f} } \vec{\Xi}^{k}_{i} \frac{\partial \momVec{}_{i}^{k}}{\partial P_{o(i)}} \delta P_{o(i)}^{k} \alert<1>{+ \dt{} \sum_{i \, \in \, N_{\text{NBC}}} \delta \vec{\Psi}^{k}_{i}} & = &\nonumber \\
- \left( \vec{F}^{k}_{c} + \sum_{i \, \in \, N_{f} } \vec{\Xi}^{k}_{i} \delta \momVec{}_{i}^{*} \alert<1>{- \dt{} \sum_{i \, \in \, N_{\text{NBC}}} \vec{\Psi}^{k}_{i}} \right) \alert<1>{- \dt{} \sum_{i \, \in \, N_{\text{NBC}}} \vec{\Psi}^{k}_{i}} & & \nonumber
\end{IEEEeqnarray}
...
\centering
\vspace{0.1in}
Using the nonlinear or the SNR solver removes the nonphysical behavior.
\vspace{0.1in}
\end{textblock}
}
...
\centering
\vspace{0.1in}
The SNR solver produces the same solution as the nonlinear solver with less computational effort.
\vspace{0.1in}
\end{textblock}
}
...
%---------
\begin{frame}
\frametitle{Downcomer and Core Effective Liquid Volume Fractions}
...
%---------
\begin{frame}
\frametitle{SNR Solver's Net Condensation}
...
\centering
\vspace{0.1in}
SNR solver shows more consistent and accurate condensation than the linear solver.
\vspace{0.1in}
\end{textblock}
}
...
\centering
\vspace{0.1in}
Net condensation for the SNR and nonlinear solvers are more consistent.
\vspace{0.1in}
\end{textblock}
}
...
\centering
\vspace{0.1in}
SNR solver provides a decrease of 50\% to 60\% in run time compared to the nonlinear solver. 
\vspace{0.1in}
\end{textblock}
}

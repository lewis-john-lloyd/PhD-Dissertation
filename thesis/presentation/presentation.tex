...
\centering
\vspace{0.1in}
The nonlinear solver provides a more nonlinearly convergent solution at larger timestep sizes.
\vspace{0.1in}
\end{textblock}
}
...
\centering
\vspace{0.1in}
The dual-domain solver produces a the same solution as the nonlinear solver with less computational effort.
\vspace{0.1in}
\end{textblock}
}

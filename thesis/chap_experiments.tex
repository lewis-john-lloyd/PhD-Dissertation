...
\fig{fig:flashing1pt0000em0} shows that the nonlinearly resolved solution is qualitatively different than the linear solution.
...
However, to simulate the presence of these fuel rods, there were two sources, points C \& D in \fig{fig:refillModel}, that produced steam within the two subchannels representing the active core.
...
The linear solutions from the four different $\dtmax{}$ are shown in \fig{fig:refillGammaLin}.
...
Next, \fig{fig:refillGammaNln} contains the integrated condensation for the four different \dtmax{} using the nonlinear solver for the entire solution.
...
Next, the net condensation for each of the three solution techniques are shown in \fig{fig:refillMaxGamma}.

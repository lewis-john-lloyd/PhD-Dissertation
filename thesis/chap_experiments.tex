...
\comment{name needs to be adjusted to valve-type problem or somesuch.}
...
\comment{Move analytic solution to the front.}\

\comment{Shift graphs so that the 14.7 is visible.}

\comment{Remove one of the two graphs below. Redundant.}
...
\input{plots/vmpLinear5em2}\label{fig:vmpLinFill5em2}
}}
\subfloat[\dtmax{} = \expneg{1.6}{3}{[s]}]{
\centering
\resizebox{!}{0.3\textwidth}{
\input{plots/vmpLinear1pt6em3}\label{fig:vmpLinFill1pt6em3}
}}

...
Each block represents a single continuity volume with a fixed \dx{} and $A_{c}$.
...
The pressure in the bottom reservoir started at 802 $[ \text{psia}]$ and to 818 $[ \text{psia}]$ over the first second, staying there for the duration of the problem.

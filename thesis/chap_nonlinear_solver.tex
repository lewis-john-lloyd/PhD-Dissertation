...
This is due to the combination of the artificially increased interfacial drag coefficient and the definitions of velocities in \cobra{}.
...
\frac{\dot{m}^{n+1}_{\phi, i}}{A_{p, i} \ave{\alpha_{\phi} \rho_{\phi}}^{n}_{\text{a}, i}} \neq \frac{\dot{m}^{n+1}_{\phi, i}}{A_{p, i} \ave{\alpha_{\phi} \rho_{\phi}}^{n+1}_{\text{a}, i}}
\end{equation}

...
u^{n}_{k, j \pm \onehalf} = \frac{\dot{m}^{n}_{k, j \pm \onehalf}}{A_{m, j \pm \onehalf} \ave{\alpha_{k} \rho_{k}}^{n}_{a, j \pm \onehalf}} 
\end{equation}
...
\frac{\dot{m}^{n+1}_{k, j \pm \onehalf}}{A_{m, j \pm \onehalf} \ave{\alpha_{k} \rho_{k}}^{n}_{a, j \pm \onehalf}} \neq \frac{\dot{m}^{n+1}_{k, j \pm \onehalf}}{A_{m, j \pm \onehalf} \ave{\alpha_{k} \rho_{k}}^{n+1}_{a, j \pm \onehalf}}
\end{equation}
...
\dot{m}^{n+1}_{d, j \pm \onehalf} = \dot{m}^{n+1}_{c, j \pm \onehalf} \frac{\ave{\alpha_{d} \rho_{d}}^{n}_{a, j \pm \onehalf}}{\ave{\alpha_{c} \rho_{c}}^{n+1}_{a, j \pm \onehalf}}
\end{equation}

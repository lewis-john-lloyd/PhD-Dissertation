...
During the next timestep, however, the old-time velocities are not only no longer equal to each other, but they are also no longer equal to the new-time velocities calculated at the end of the previous timestep.

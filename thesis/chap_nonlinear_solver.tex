...
\comment{Here is where I am trying to explain what isolated domains mean.}
...
The \comment{accuracy or some other term} of a given solution can be measured by a norm of the residual vector of the nonlinear system.
...
\comment{here is where I need to reference Frepoli's paper.}

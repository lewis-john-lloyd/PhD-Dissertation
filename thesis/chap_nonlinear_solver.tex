...
\begin{equation}
\label{eqn:momStar}
\dot{\vec{m}}_{j}^{n+1} = \vec{J}_{m,j}^{-1} \vec{a}_{j} + \sum^{N_{c}}_{i\,=\,1} \vec{J}_{m,j}^{-1} \vec{b}_{j} \delta P_{i} = \dot{\vec{m}}^{*}_{j} + \sum^{N_{c}}_{i\,=\,1} \frac{\partial \dot{\vec{m}}_{j}}{\partial P_{i}} \delta P_{i}
\end{equation}
